...
using SendNotificationTest.Resources;
using Microsoft.Phone.Notification;
using Microsoft.WindowsAzure.Messaging;

namespace SendNotificationTest
{
    public partial class App : Application
    {
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            {
                var hub = new NotificationHub("alarm", "Endpoint=sb://ostolztest.servicebus.windows.net/;SharedAccessKeyName=DefaultFullSharedAccessSignature;SharedAccessKey=GjACXVLUAmQ0MPc7Or4uvAVBTgnYzeBwqWo31oklg1s=");
